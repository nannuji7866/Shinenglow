...
export default function Hero() {
  ...
  return (
    <section id="home" ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#050403] pt-20">
        ...
        <div className="w-full max-w-4xl mx-auto">
          ...
          >
            ...
            <motion.p 
              ...
              className="text-gray-300 text-sm md:text-base max-w-xl mx-auto mb-12 leading-relaxed font-light"
            >
